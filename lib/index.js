 ...
 */
const createTableRows = (dataToDisplay = [], dataLabel = "qa-e-info") => {
...
const closeId = "js-qa-m-infobox__copy";
...
export default class QaInfobox {
   ...
   */
  updateViewport () {
    this.el.querySelector("[data-qa-e-info='viewport'] .qa-e-data").textContent = getDataStrategy.viewport();
  }
  ...
  appendServerInfo(response) {
    ...
    const rowsToAppend = createTableRows(dataToDisplay, "qa-e-serverinfo");
  ...
  createPopup(dataToDisplay = []) {
    ...
    const windowContent = createTableRows(dataToDisplay, "qa-e-info");
    ...
    setTimeout(() => {
      ...
      if (this.el) {
        ...
        this.el.querySelector(".qa-e-content")
